...
set ::env(PL_TARGET_DENSITY_PCT) 35
set ::env(PL_SKIP_INITIAL_PLACEMENT) 0
set ::env(PL_WIRE_LENGTH_COEF) 0.25
set ::env(FP_CORE_UTIL) 50
set ::env(GPL_CELL_PADDING) 0
set ::env(IO_PIN_PLACEMENT_MODE) matching
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-03_00-34-52/22-openroad-generatepdn/chip_top.odb
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-03_00-34-52/25-openroad-globalplacementskipio/chip_top.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-03_00-34-52/25-openroad-globalplacementskipio/chip_top.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-03_00-34-52/25-openroad-globalplacementskipio/chip_top.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-03_00-34-52/25-openroad-globalplacementskipio/chip_top.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-03_00-34-52/25-openroad-globalplacementskipio/chip_top.pnl.v
