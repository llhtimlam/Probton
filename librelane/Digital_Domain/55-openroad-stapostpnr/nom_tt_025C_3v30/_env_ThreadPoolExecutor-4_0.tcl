...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_11-38-06/52-openroad-fillinsertion/wrapper.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /workspace/librelane/runs/RUN_2026-08-10_11-38-06/54-openroad-rcx/nom/wrapper.nom.spef \"min_*\" /workspace/librelane/runs/RUN_2026-08-10_11-38-06/54-openroad-rcx/min/wrapper.min.spef \"max_*\" /workspace/librelane/runs/RUN_2026-08-10_11-38-06/54-openroad-rcx/max/wrapper.max.spef"
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-10_11-38-06/53-odb-cellfrequencytables/wrapper.odb
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_11-38-06/55-openroad-stapostpnr/wrapper.sdc
