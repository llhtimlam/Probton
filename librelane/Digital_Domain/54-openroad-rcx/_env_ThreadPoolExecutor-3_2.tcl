...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-10_11-38-06/53-odb-cellfrequencytables/wrapper.def
...
set ::env(SAVE_SPEF) /workspace/librelane/runs/RUN_2026-08-10_11-38-06/54-openroad-rcx/max/wrapper.max.spef
