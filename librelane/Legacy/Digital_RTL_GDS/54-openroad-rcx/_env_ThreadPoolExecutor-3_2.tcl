...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/53-odb-cellfrequencytables/digital_domain.def
...
set ::env(SAVE_SPEF) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/54-openroad-rcx/max/digital_domain.max.spef
