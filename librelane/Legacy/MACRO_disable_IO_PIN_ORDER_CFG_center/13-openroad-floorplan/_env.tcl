set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-09_21-37-48/13-openroad-floorplan/config.tracks
...
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-09_21-37-48/13-openroad-floorplan/chip_core.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-09_21-37-48/13-openroad-floorplan/chip_core.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-09_21-37-48/13-openroad-floorplan/chip_core.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-09_21-37-48/13-openroad-floorplan/chip_core.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-09_21-37-48/13-openroad-floorplan/chip_core.pnl.v
