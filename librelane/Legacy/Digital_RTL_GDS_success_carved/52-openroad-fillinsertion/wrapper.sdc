...
set_input_delay 40.0000 -clock [get_clocks {clk}] -add_delay [get_ports {analog_readout_input}]
...
set_output_delay 40.0000 -clock [get_clocks {clk}] -add_delay [get_ports {analog_error_x_output}]
set_output_delay 40.0000 -clock [get_clocks {clk}] -add_delay [get_ports {analog_error_y_output}]
set_output_delay 40.0000 -clock [get_clocks {clk}] -add_delay [get_ports {analog_readout_output}]
...
# Environment
###############################################################################
set_load -pin_load 0.0729 [get_ports {analog_error_x_output}]
set_load -pin_load 0.0729 [get_ports {analog_error_y_output}]
set_load -pin_load 0.0729 [get_ports {analog_readout_output}]
...
set_driving_cell -lib_cell gf180mcu_fd_sc_mcu7t5v0__inv_1 -pin {ZN} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {analog_readout_input}]
