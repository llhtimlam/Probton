...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/53-odb-cellfrequencytables/wrapper.def
set ::env(RCX_LEF) /workspace/gf180mcu/gf180mcuD/libs.ref/gf180mcu_fd_sc_mcu7t5v0/techlef/gf180mcu_fd_sc_mcu7t5v0__max.tlef
set ::env(RCX_RULESET) /workspace/gf180mcu/gf180mcuD/libs.tech/librelane/rules.openrcx.gf180mcuD.max
set ::env(SAVE_SPEF) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/54-openroad-rcx/max/wrapper.max.spef
