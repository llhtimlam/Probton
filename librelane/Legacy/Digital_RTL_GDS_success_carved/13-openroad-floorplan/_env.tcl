set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/13-openroad-floorplan/config.tracks
...
set ::env(DIE_AREA) "0 0.0 1117.5 758.75"
set ::env(MACROS) "analog_block \"gds /workspace/librelane/analog_block.gds lef /workspace/librelane/analog_block.lef instances \\\"analog_block_inst \\\\\\\"location \\\\\\\\\\\\\\\"267.64 10.0\\\\\\\\\\\\\\\" orientation N\\\\\\\"\\\" vh /workspace/src/analog_macro.sv nl \\\"\\\" pnl \\\"\\\" spef \\\"\\\" lib \\\"\\\" spice \\\"\\\" sdf \\\"\\\" json_h None\""
...
set ::env(FP_OBSTRUCTIONS) "\"267.64 10.0 747.64 250\""
set ::env(CORE_AREA) "10 10.0 1107.5 748.75"
set ::env(BOTTOM_MARGIN_MULT) 4
set ::env(TOP_MARGIN_MULT) 4
set ::env(LEFT_MARGIN_MULT) 12
set ::env(RIGHT_MARGIN_MULT) 12
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/06-yosys-synthesis/wrapper.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/13-openroad-floorplan/wrapper.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/13-openroad-floorplan/wrapper.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/13-openroad-floorplan/wrapper.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/13-openroad-floorplan/wrapper.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_10-35-54/13-openroad-floorplan/wrapper.pnl.v
