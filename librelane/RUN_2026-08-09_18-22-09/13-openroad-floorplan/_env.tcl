set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-09_18-22-09/13-openroad-floorplan/config.tracks
...
set ::env(DIE_AREA) "-1117.5 0.0 2235.0 1117.5"
set ::env(MACROS) "analog_block \"gds /workspace/librelane/analog_block.gds lef /workspace/librelane/analog_block.lef instances \\\"analog_block_inst \\\\\\\"location \\\\\\\\\\\\\\\"318.75 0.0\\\\\\\\\\\\\\\" orientation N\\\\\\\"\\\" vh /workspace/src/analog_macro.sv nl \\\"\\\" pnl \\\"\\\" spef \\\"\\\" lib \\\"\\\" spice \\\"\\\" sdf \\\"\\\" json_h None\""
...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-09_18-22-09/06-yosys-synthesis/chip_core.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-09_18-22-09/13-openroad-floorplan/chip_core.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-09_18-22-09/13-openroad-floorplan/chip_core.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-09_18-22-09/13-openroad-floorplan/chip_core.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-09_18-22-09/13-openroad-floorplan/chip_core.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-09_18-22-09/13-openroad-floorplan/chip_core.pnl.v
