set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-09_19-31-35/13-openroad-floorplan/config.tracks
...
set ::env(FP_OBSTRUCTIONS) "\"318.75 0.0 798.75 220.0\""
set ::env(CORE_AREA) "442 442 2493 2493"
set ::env(BOTTOM_MARGIN_MULT) 4
set ::env(TOP_MARGIN_MULT) 4
set ::env(LEFT_MARGIN_MULT) 12
set ::env(RIGHT_MARGIN_MULT) 12
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-09_19-31-35/06-yosys-synthesis/chip_core.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-09_19-31-35/13-openroad-floorplan/chip_core.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-09_19-31-35/13-openroad-floorplan/chip_core.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-09_19-31-35/13-openroad-floorplan/chip_core.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-09_19-31-35/13-openroad-floorplan/chip_core.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-09_19-31-35/13-openroad-floorplan/chip_core.pnl.v
