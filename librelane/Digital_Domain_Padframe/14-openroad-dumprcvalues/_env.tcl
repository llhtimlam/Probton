...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-26_23-49-04/13-openroad-floorplan/wrapper_top.def
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-26_23-49-04/14-openroad-dumprcvalues/wrapper_top.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-26_23-49-04/14-openroad-dumprcvalues/wrapper_top.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-26_23-49-04/14-openroad-dumprcvalues/wrapper_top.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-26_23-49-04/14-openroad-dumprcvalues/wrapper_top.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-26_23-49-04/14-openroad-dumprcvalues/wrapper_top.pnl.v
