...
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/26-odb-customioplacement/wave_controller.odb
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/28-openroad-globalplacement/wave_controller.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/28-openroad-globalplacement/wave_controller.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/28-openroad-globalplacement/wave_controller.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/28-openroad-globalplacement/wave_controller.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/28-openroad-globalplacement/wave_controller.pnl.v
