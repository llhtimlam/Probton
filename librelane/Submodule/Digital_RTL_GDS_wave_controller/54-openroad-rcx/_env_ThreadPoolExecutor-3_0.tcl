...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/53-odb-cellfrequencytables/wave_controller.def
...
set ::env(SAVE_SPEF) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/54-openroad-rcx/nom/wave_controller.nom.spef
