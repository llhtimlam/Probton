...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/52-openroad-fillinsertion/wave_controller.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /workspace/librelane/runs/RUN_2026-08-10_00-21-44/54-openroad-rcx/nom/wave_controller.nom.spef \"min_*\" /workspace/librelane/runs/RUN_2026-08-10_00-21-44/54-openroad-rcx/min/wave_controller.min.spef \"max_*\" /workspace/librelane/runs/RUN_2026-08-10_00-21-44/54-openroad-rcx/max/wave_controller.max.spef"
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/53-odb-cellfrequencytables/wave_controller.odb
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/55-openroad-stapostpnr/wave_controller.sdc
