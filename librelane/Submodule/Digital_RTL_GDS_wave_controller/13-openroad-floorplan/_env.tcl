set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/13-openroad-floorplan/config.tracks
...
set ::env(DESIGN_NAME) wave_controller
...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/06-yosys-synthesis/wave_controller.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/13-openroad-floorplan/wave_controller.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/13-openroad-floorplan/wave_controller.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/13-openroad-floorplan/wave_controller.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/13-openroad-floorplan/wave_controller.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/13-openroad-floorplan/wave_controller.pnl.v
