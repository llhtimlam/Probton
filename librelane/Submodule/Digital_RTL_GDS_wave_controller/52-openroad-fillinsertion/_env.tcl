...
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/48-odb-reportdisconnectedpins/wave_controller.odb
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/52-openroad-fillinsertion/wave_controller.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/52-openroad-fillinsertion/wave_controller.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/52-openroad-fillinsertion/wave_controller.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/52-openroad-fillinsertion/wave_controller.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_00-21-44/52-openroad-fillinsertion/wave_controller.pnl.v
