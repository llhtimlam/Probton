set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-09_23-45-37/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-09_23-45-37/06-yosys-synthesis/state_machine.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-09_23-45-37/13-openroad-floorplan/state_machine.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-09_23-45-37/13-openroad-floorplan/state_machine.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-09_23-45-37/13-openroad-floorplan/state_machine.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-09_23-45-37/13-openroad-floorplan/state_machine.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-09_23-45-37/13-openroad-floorplan/state_machine.pnl.v
