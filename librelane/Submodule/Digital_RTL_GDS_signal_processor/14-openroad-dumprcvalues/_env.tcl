...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/13-openroad-floorplan/signal_processor.def
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/14-openroad-dumprcvalues/signal_processor.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/14-openroad-dumprcvalues/signal_processor.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/14-openroad-dumprcvalues/signal_processor.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/14-openroad-dumprcvalues/signal_processor.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/14-openroad-dumprcvalues/signal_processor.pnl.v
