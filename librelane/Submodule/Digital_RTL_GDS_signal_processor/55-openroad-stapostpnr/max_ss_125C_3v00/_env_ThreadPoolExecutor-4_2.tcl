...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/52-openroad-fillinsertion/signal_processor.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /workspace/librelane/runs/RUN_2026-08-10_00-05-58/54-openroad-rcx/nom/signal_processor.nom.spef \"min_*\" /workspace/librelane/runs/RUN_2026-08-10_00-05-58/54-openroad-rcx/min/signal_processor.min.spef \"max_*\" /workspace/librelane/runs/RUN_2026-08-10_00-05-58/54-openroad-rcx/max/signal_processor.max.spef"
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/53-odb-cellfrequencytables/signal_processor.odb
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/55-openroad-stapostpnr/signal_processor.sdc
