...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/53-odb-cellfrequencytables/signal_processor.def
...
set ::env(SAVE_SPEF) /workspace/librelane/runs/RUN_2026-08-10_00-05-58/54-openroad-rcx/nom/signal_processor.nom.spef
