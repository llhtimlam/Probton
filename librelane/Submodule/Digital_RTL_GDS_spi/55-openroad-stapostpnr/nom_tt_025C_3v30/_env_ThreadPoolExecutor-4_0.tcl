...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/52-openroad-fillinsertion/spi_regs.nl.v
set ::env(CURRENT_SPEF) "\"nom_*\" /workspace/librelane/runs/RUN_2026-08-10_00-37-52/54-openroad-rcx/nom/spi_regs.nom.spef \"min_*\" /workspace/librelane/runs/RUN_2026-08-10_00-37-52/54-openroad-rcx/min/spi_regs.min.spef \"max_*\" /workspace/librelane/runs/RUN_2026-08-10_00-37-52/54-openroad-rcx/max/spi_regs.max.spef"
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/53-odb-cellfrequencytables/spi_regs.odb
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/55-openroad-stapostpnr/spi_regs.sdc
