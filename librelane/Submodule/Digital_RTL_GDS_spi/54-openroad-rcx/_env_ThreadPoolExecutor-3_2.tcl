...
set ::env(CURRENT_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/53-odb-cellfrequencytables/spi_regs.def
...
set ::env(SAVE_SPEF) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/54-openroad-rcx/max/spi_regs.max.spef
