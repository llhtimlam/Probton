...
set ::env(CURRENT_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/48-odb-reportdisconnectedpins/spi_regs.odb
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/52-openroad-fillinsertion/spi_regs.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/52-openroad-fillinsertion/spi_regs.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/52-openroad-fillinsertion/spi_regs.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/52-openroad-fillinsertion/spi_regs.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/52-openroad-fillinsertion/spi_regs.pnl.v
