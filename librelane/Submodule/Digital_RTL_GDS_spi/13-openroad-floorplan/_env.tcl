set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/06-yosys-synthesis/spi_regs.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/13-openroad-floorplan/spi_regs.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/13-openroad-floorplan/spi_regs.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/13-openroad-floorplan/spi_regs.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/13-openroad-floorplan/spi_regs.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_00-37-52/13-openroad-floorplan/spi_regs.pnl.v
