set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/06-yosys-synthesis/digital_domain.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/13-openroad-floorplan/digital_domain.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/13-openroad-floorplan/digital_domain.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/13-openroad-floorplan/digital_domain.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/13-openroad-floorplan/digital_domain.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-10_01-25-13/13-openroad-floorplan/digital_domain.pnl.v
