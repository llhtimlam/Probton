set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/librelane/runs/RUN_2026-08-03_06-58-25/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /workspace/librelane/runs/RUN_2026-08-03_06-58-25/06-yosys-synthesis/chip_core.nl.v
set ::env(SAVE_ODB) /workspace/librelane/runs/RUN_2026-08-03_06-58-25/13-openroad-floorplan/chip_core.odb
set ::env(SAVE_DEF) /workspace/librelane/runs/RUN_2026-08-03_06-58-25/13-openroad-floorplan/chip_core.def
set ::env(SAVE_SDC) /workspace/librelane/runs/RUN_2026-08-03_06-58-25/13-openroad-floorplan/chip_core.sdc
set ::env(SAVE_NL) /workspace/librelane/runs/RUN_2026-08-03_06-58-25/13-openroad-floorplan/chip_core.nl.v
set ::env(SAVE_PNL) /workspace/librelane/runs/RUN_2026-08-03_06-58-25/13-openroad-floorplan/chip_core.pnl.v
