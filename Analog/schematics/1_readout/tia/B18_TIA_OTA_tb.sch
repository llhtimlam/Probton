...
C {devices/isource.sym} 210 140 0 0 {name=I0 value=100u}
...
only_toplevel=false
value="
.param vdd=3.3 vcm=2.2

.control
    save all

    op
    show m.x1.xmn_in_pos.m0
    show m.x1.xmp_mir_pos.m0
    show m.x1.xmn_tail.m0
    show m.x1.xmn_switch.m0

    write B18_TIA_OTA_tb.raw
    set appendwrite
...
C {devices/code_shown.sym} 960 180 0 0 {name=MODELS only_toplevel=true
