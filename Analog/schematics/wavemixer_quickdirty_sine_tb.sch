...
C {bsource.sym} 470 -130 0 0 {name=B1 VAR=V FUNC="\{1.2 + 0.1*sin(2*pi*156k*time + pi/2)\}" m=1}
C {bsource.sym} 470 30 0 0 {name=B2 VAR=V FUNC="\{1.2 + 0.1*sin(2*pi*156k*time + 3*pi/2)\}" m=1
lab=v_rf_b}
