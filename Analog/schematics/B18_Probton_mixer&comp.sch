...
C {lab_pin.sym} -80 -590 2 1 {name=p1 sig_type=std_logic lab=VDD_3v3}
...
C {lab_pin.sym} -80 -270 2 1 {name=p5 sig_type=std_logic lab=ref_x_dig_sq}
...
C {lab_pin.sym} -80 590 2 1 {name=p2 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -80 -380 2 1 {name=p9 sig_type=std_logic lab=clk}
C {lab_pin.sym} -80 -20 2 1 {name=p10 sig_type=std_logic lab=readout}
...
C {symbols/ppolyf_u_3k.sym} 770 230 3 1 {name==1
W=1u
L=48u
model=ppolyf_u_3k
spiceprefix=r
...
C {lab_pin.sym} -80 270 2 1 {name=p14 sig_type=std_logic lab=ref_y_dig_sq}
