...
N 2030 -310 2070 -310 {lab=comp_x}
...
N 2030 310 2070 310 {lab=comp_y}
...
N -310 30 -310 230 {lab=#net22}
N -950 30 -950 230 {lab=#net22}
N -1150 -60 -1030 -60 {lab=#net23}
N -1100 -220 -1100 -60 {lab=#net23}
N -1120 -220 -1100 -220 {lab=#net23}
...
N -550 -270 -550 -120 {lab=#net24}
N -550 -120 -550 -60 {lab=#net24}
...
N -880 -230 -700 -230 {lab=#net24}
N -880 -60 -390 -60 {lab=#net24}
N -620 -220 -620 230 {lab=#net22}
...
C {lab_pin.sym} -1420 -360 2 1 {name=p5 sig_type=std_logic lab=ref_x_dig_sq}
...
C {symbols/cap_mim_analog.sym} 820 -180 0 0 {name="=3.65pF"
W=42.74u
L=42.74u
model="cap_mim_2f0
_m3m4_noshield"
...
C {lab_pin.sym} 2070 -310 2 0 {name=p8 sig_type=std_logic lab=comp_x}
C {lab_pin.sym} -1420 590 2 1 {name=p2 sig_type=std_logic lab=VSS}
C {lab_pin.sym} -1420 -380 2 1 {name=p9 sig_type=std_logic lab=clk}
...
C {symbols/ppolyf_u_3k.sym} 770 230 3 1 {name="=144kΩ_"
W=1u
L=48u
model=ppolyf_u_3k
spiceprefix=r
...
C {symbols/cap_mim_analog.sym} 820 180 2 1 {name="=3.65pF_"
W=42.74u
L=42.74u
model="cap_mim_2f0
_m3m4_noshield"
...
C {lab_pin.sym} 2080 500 2 0 {name=p18 sig_type=std_logic lab=analog_error_y_output}
C {lab_pin.sym} 2080 -530 2 0 {name=p19 sig_type=std_logic lab=analog_error_x_output}
...
spiceprefix=X
m=1}
C {lab_pin.sym} 2080 -20 2 0 {name=p10 sig_type=std_logic lab=analog_readout_output}
