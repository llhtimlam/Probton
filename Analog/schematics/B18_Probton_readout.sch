...
N -310 30 -310 230 {lab=read_en}
N -950 30 -950 230 {lab=read_en}
N -1150 -60 -1030 -60 {lab=#net1}
N -1100 -220 -1100 -60 {lab=#net1}
N -1120 -220 -1100 -220 {lab=#net1}
...
N -550 -270 -550 -120 {lab=#net2}
N -550 -120 -550 -60 {lab=#net2}
...
N -880 -230 -700 -230 {lab=#net2}
N -880 -60 -390 -60 {lab=#net2}
N -620 -220 -620 230 {lab=read_en}
